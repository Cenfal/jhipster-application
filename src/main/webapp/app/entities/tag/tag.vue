<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jhipsterApplicationApp.tag.home.title')" id="tag-heading">Tags</span>
            <router-link :to="{name: 'TagCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-tag">
                ...
                <span  v-text="$t('jhipsterApplicationApp.tag.home.createLabel')">
                    Create a new Tag
                </span>
            </router-link>
        </h2>
        ...
        <div class="alert alert-warning" v-if="!isFetching && tags && tags.length === 0">
            <span v-text="$t('jhipsterApplicationApp.tag.home.notFound')">No tags found</span>
        </div>
        <div class="table-responsive" v-if="tags && tags.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jhipsterApplicationApp.tag.tag')">Tag</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jhipsterApplicationApp.tag.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-tag-heading" v-text="$t('jhipsterApplicationApp.tag.delete.question', {'id': removeId})">Are you sure you want to delete this Tag?</p>
            </div>
