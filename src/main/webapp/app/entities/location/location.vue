<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jhipsterApplicationApp.location.home.title')" id="location-heading">Locations</span>
            <router-link :to="{name: 'LocationCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-location">
                ...
                <span  v-text="$t('jhipsterApplicationApp.location.home.createLabel')">
        ...
        <div class="alert alert-warning" v-if="!isFetching && locations && locations.length === 0">
            <span v-text="$t('jhipsterApplicationApp.location.home.notFound')">No locations found</span>
        </div>
        <div class="table-responsive" v-if="locations && locations.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jhipsterApplicationApp.location.streetAddress')">Street Address</span></th>
                    <th><span v-text="$t('jhipsterApplicationApp.location.postalCode')">Postal Code</span></th>
                    <th><span v-text="$t('jhipsterApplicationApp.location.city')">City</span></th>
                    <th><span v-text="$t('jhipsterApplicationApp.location.stateProvince')">State Province</span></th>
                    <th><span v-text="$t('jhipsterApplicationApp.location.country')">Country</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jhipsterApplicationApp.location.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-location-heading" v-text="$t('jhipsterApplicationApp.location.delete.question', {'id': removeId})">Are you sure you want to delete this Location?</p>
            </div>
