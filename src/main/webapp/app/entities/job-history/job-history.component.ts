...
export default class JobHistory extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public removeJobHistory(): void {
    this.jobHistoryService()
      ...
      .then(() => {
        const message = this.$t('jhipsterApplicationApp.jobHistory.deleted', { param: this.removeId });
