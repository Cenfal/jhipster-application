    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="jhipsterApplicationApp.department.home.createOrEditLabel" v-text="$t('jhipsterApplicationApp.department.home.createOrEditLabel')">Create or edit a Department</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApplicationApp.department.departmentName')" for="department-departmentName">Department Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApplicationApp.department.location')" for="department-location">Location</label>
                        <select class="form-control" id="department-location" name="location" v-model="department.locationId">
