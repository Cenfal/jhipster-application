...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.CommentHistory}.
 */
@RestController
@RequestMapping("/api")
public class CommentHistoryResource {
    ...
    public ResponseEntity<CommentHistoryDTO> createCommentHistory(@RequestBody CommentHistoryDTO commentHistoryDTO) throws URISyntaxException {
    ...
    public ResponseEntity<CommentHistoryDTO> updateCommentHistory(@RequestBody CommentHistoryDTO commentHistoryDTO) throws URISyntaxException {
